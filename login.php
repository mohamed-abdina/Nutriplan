...
// Debug logging to login_debug.log removed for production safety (PII risk)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Debug POST logging omitted to avoid writing PII to web-accessible logs
    ...
    if ($is_ajax) {
        ...
        // Debug AJAX logging omitted to avoid writing PII to web-accessible logs
        exit;
    }
}
...
if ($is_ajax) {
    ...
    // Debug AJAX non-POST logging omitted to avoid writing PII to web-accessible logs
    exit;
}
