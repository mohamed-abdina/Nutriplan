...
$list_info = pdo_fetch_one("SELECT COUNT(*) as lists FROM carts WHERE user_id = ?", [$user_id]) ?? ['lists' => 0];
                    ...
                    list.innerHTML = data.wishlist.map(meal => `
                        <div style="background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: var(--sp-4); overflow: hidden;">
                            ...
                            <div style="display: flex; gap: var(--sp-2);">
                                <a href="meal.php?meal_id=${meal.meal_id}" class="btn btn-outline btn-sm" style="flex: 1; text-align: center;">Details</a>
